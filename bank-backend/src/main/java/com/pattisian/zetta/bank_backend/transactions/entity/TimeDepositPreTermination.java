...
public class TimeDepositPreTermination extends Transaction {
    ...
    public TimeDepositPreTermination() {
    }

    public TimeDepositPreTermination(User user, BigDecimal amount, BigDecimal balanceBeforeTransaction, BigDecimal balanceAfterTransaction, Account payoutAccount, TimeDeposit timeDeposit) {
        super(TransactionType.TIME_DEPOSIT_PRE_TERMINATION, user, amount, balanceBeforeTransaction, balanceAfterTransaction);
